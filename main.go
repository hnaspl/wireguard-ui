...
func main() {
	...
	app.GET(util.BasePath+"/firewall-rules", handler.FirewallRules(db), handler.ValidSession, handler.RefreshSession, handler.NeedsAdmin)
	app.GET(util.BasePath+"/api/firewall-rules", handler.GetFirewallRules(db), handler.ValidSession, handler.NeedsAdmin)
	app.GET(util.BasePath+"/api/firewall-rule/:id", handler.GetFirewallRule(db), handler.ValidSession, handler.NeedsAdmin)
	app.POST(util.BasePath+"/api/firewall-rule", handler.SaveFirewallRule(db), handler.ValidSession, handler.ContentTypeJson, handler.NeedsAdmin)
	app.PUT(util.BasePath+"/api/firewall-rule/:id", handler.UpdateFirewallRule(db), handler.ValidSession, handler.ContentTypeJson, handler.NeedsAdmin)
	app.DELETE(util.BasePath+"/api/firewall-rule/:id", handler.DeleteFirewallRule(db), handler.ValidSession, handler.ContentTypeJson, handler.NeedsAdmin)
	...
	app.GET(util.BasePath+"/api/interfaces/:id", handler.GetInterface(db), handler.ValidSession, handler.NeedsAdmin)
	app.POST(util.BasePath+"/api/interfaces", handler.CreateInterface(db), handler.ValidSession, handler.ContentTypeJson, handler.NeedsAdmin)
